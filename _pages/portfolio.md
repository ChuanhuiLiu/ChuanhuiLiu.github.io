...
<style>
  ...
  .acc-panel.active .acc-list-item:nth-child(5)  { transition-delay: 0.54s; }
  .acc-panel.active .acc-list-item:nth-child(6)  { transition-delay: 0.60s; }
    ...
    <div class="acc-content">
      ...
      <div class="acc-list">
        ...
        {% if portfolio_items.size > 0 %}
          {% for item in portfolio_items limit:6 %}
    ...
    <div class="acc-content">
      ...
      <div class="acc-list">
        ...
        {% if notebook_items.size > 0 %}
          {% for item in notebook_items limit:6 %}
          <a class="acc-list-item" href="{{ item.url }}">
            <span class="acc-list-item__name">{{ item.title }}</span>
    ...
    <div class="acc-content">
      ...
      <div class="acc-list">
        ...
        {% if tool_items.size > 0 %}
          {% for item in tool_items limit:6 %}
          <a class="acc-list-item" href="{{ item.url }}">
            <span class="acc-list-item__name">{{ item.title }}</span>
          </a>
          {% endfor %}
